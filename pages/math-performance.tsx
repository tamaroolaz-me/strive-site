...
export default function MathPerformance() {
  return (
    <>
      <Head>
        <title>Maths Performance — Strive</title>
        <meta name="description" content="Improve your child's mathematics grades with structured 1-on-1 coaching. Expert tutors, proven methods, measurable results." />
