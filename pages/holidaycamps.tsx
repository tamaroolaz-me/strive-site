...
export default function HolidayCamps() {
  return (
    <>
      <Head>
        <title>Holiday Bootcamps — Strive</title>
        <meta name="description" content="Intensive mathematics and coding bootcamps during school holidays in Singapore. Small groups, expert tutors, real progress." />
