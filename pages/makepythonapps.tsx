...
export default function MakePythonApps() {
  return (
    <>
      <Head>
        <title>Make Python Apps — Strive</title>
        <meta name="description" content="Learn to build real Python applications from scratch with 1-on-1 online coaching. Hands-on projects, beginner-friendly, results you can show off." />
