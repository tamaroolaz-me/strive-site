...
export default function AIFirstCodingBootcamp() {
  return (
    <>
      <Head>
        <title>AI-First Coding Bootcamp — Strive</title>
        <meta name="description" content="An intensive bootcamp for building real software with AI tools. Learn to ship products, not just write code, in a focused multi-day programme." />
